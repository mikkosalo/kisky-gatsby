  ...
  return (
    <Layout title="Seura" description="Kirkkonummen Seudun Kiipeilijät Ry perustettiin vuonna 2014 paikallisten kiipeilijöiden toimesta">
      ...
      <Section background="primary">
        <Content>
          <h1>Seura</h1>
          <p>Kirkkonummen Seudun Kiipeilijät RY perustettiin vuonna 2014, kun ryhmä lähiseudun kiipeilijöitä kokoontuita yhteen rakentaakseen Masalan monitoimitaloon boulderkiipeilytilan eli lyhyesti ’Masalan keivin’.</p>
